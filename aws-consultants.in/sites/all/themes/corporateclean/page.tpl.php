    ...
    <div id="slideshow">
        ...
        <div class="slider-item">
            <div class="content container_12">
                ...
                <br/>
                We offer online training on Drupal module, theme development.
                <br/>
		We conduct regular training sessions on week ends.
                <br/>
		We offer special training for corporates
                <div style="display:block; padding:30px 0 10px 0;"><a class="more" href="/contact">Contact for Quote</a></div>
        ...
        <div class="slider-item">
            <div class="content container_12">
                ...
                <br/>
		<ul>
                <li> Website in Drupal </li>
		<li> AWS Hosting </li>
		<li> Server setup </li>
		<li> Search Engine Optimization </li>
		<li> Training in Drupal </li>
		<li> Optimizing Page load Performance </li>
		<li> Configure Mod security. </li>
		</ul>
		<div style="display:block; padding:30px 0 10px 0;"><a class="more" href="/contact">Request for Quote</a></div>
                <!--EOF:slider-item content-->
